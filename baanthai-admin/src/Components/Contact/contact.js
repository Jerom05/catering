...
const PhotographyRequest = ()=>{
    ...
    useEffect(()=>{
        const getData = async() =>{
            try{
                const decoration = await axios.get('https://baanthai.herokuapp.com/api/admin/get/contact')  
    ...
    return(
        ...
        <div className="container">
            ...
            <h2 className="text-center">Contact Requets</h2>
            <hr></hr>
            <br />
            {
                decoration.length ===0 ? <h3>We Have no request now</h3> : <h5>Total {decoration.length} Contact request</h5>
            }
